...
cp -r "$REPO_ROOT/models" "$RUNTIME_DIR/"
cp -r "$REPO_ROOT/routes" "$RUNTIME_DIR/"
cp -r "$REPO_ROOT/services" "$RUNTIME_DIR/"
cp -r "$REPO_ROOT/templates" "$RUNTIME_DIR/"
cp -r "$REPO_ROOT/static" "$RUNTIME_DIR/"
cp -r "$REPO_ROOT/migrations" "$RUNTIME_DIR/"
cp "$REPO_ROOT/app.py" "$RUNTIME_DIR/"
cp "$REPO_ROOT/config.py" "$RUNTIME_DIR/"
cp "$REPO_ROOT/extensions.py" "$RUNTIME_DIR/"
cp "$REPO_ROOT/scoping.py" "$RUNTIME_DIR/"
cp "$REPO_ROOT/cli.py" "$RUNTIME_DIR/"
