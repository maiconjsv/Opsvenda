...
Exec=${SCRIPT_DIR}/.venv-desktop/bin/python ${SCRIPT_DIR}/run_desktop.py --url http://localhost:${PORT}
Terminal=false
Categories=Office;
EOF
...
echo "  ./.venv-desktop/bin/python run_desktop.py --url http://localhost:${PORT}"
